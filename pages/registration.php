...
<body class="body registration-body">
    <div class="registration">
        <?
            $message = $_SESSION['message'];
            echo "
                <h2 class='registration-message'>$message</h2>
            ";
            unset($_SESSION['message']);
        ?>
        <div class="registration__block">
            <h1 class="registration__title">Регистарция</h1>
            <form class="registration__form entry__form" method="post" action="../php/registration.php">
            ...
            <h3 class="registration__question">Уже есть аккаунт?</h3>
            <a class="registration__swap" href="/spectr-nn/pages/entry.php">Войти</a>
        </div>
    </div>
    <?
        echo "<div class='get-category'>$get_category</div>";
    ?>
    <script src="../source/js/registration.js"></script>
</body>
</html>