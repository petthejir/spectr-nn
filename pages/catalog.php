                        ...
                        <div class="main-catalog__cards" id="cards">
                            <div class="card">
                                <div class="card__conteiner">
                                    ...
                                    <div class="card__title">
                                        <h4 class="card__title-value">яблоко</h4>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card__conteiner">
                                    ...
                                    <img class="card__img-block" src="../pics/test.jpg" alt="">
                                    <div class="card__title">
                                        <h4 class="card__title-value">груша</h4>
                                    </div>
                                    <div class="card__bottom">
                                        <div class="card__price">
                            ...
                            <div class="card">
                                <div class="card__conteiner">
                                    ...
                                    <img class="card__img-block" src="../pics/test.jpg" alt="">
                                    <div class="card__title">
                                        <h4 class="card__title-value">персик</h4>
                                    </div>
                                    <div class="card__bottom">
                                        <div class="card__price">
                                            <h2 class="card__price-old" data-old-price="124">124,99 ₽</h2>
                            ...
                            <div class="card">
                                <div class="card__conteiner">
                                    ...
                                    <img class="card__img-block" src="../pics/test.jpg" alt="">
                                    <div class="card__title">
                                        <h4 class="card__title-value">дыня</h4>
                                    </div>
                                    <div class="card__bottom">
                                        <div class="card__price">
                            ...
                            <div class="card">
                                <div class="card__conteiner">
                                    ...
                                    <img class="card__img-block" src="../pics/test.jpg" alt="">
                                    <div class="card__title">
                                        <h4 class="card__title-value">арбуз</h4>
                                    </div>
                                    <div class="card__bottom">
                                        <div class="card__price">
